...
public class AddUserWithParameters {
...
@Test(priority=1,dataProvider="addUserData")
   public void userWithParam(String Firstname, String LastName, String User, String Password, String rolename, String email, String phone, String Company) throws InterruptedException, IOException
  {
...
String [][] addUser()
{
	String addUser[][]={ {"FName1","LName1","User1","pass1","Admin","admin@mail.com","082555","15"},{"FName2","LName2","User2","pass2","Customer","Customer@mail.com","082444","16"}};
	 return(addUser); 
} 
} 
